...
export const skillsConfig = [
    {
      ...
      icon: SiPython,
      usage: 90,
      description: "I use Python for scripting, automation, and solving algorithmic problems.",
    },
    {
      id: "typescript",
      skill: "TypeScript",
      icon: SiTypescript,
      usage: 80,
      description: "I use TypeScript daily to build scalable, type-safe frontends at work.",
    },
    {
      id: "react",
      skill: "React",
      icon: SiReact,
      usage: 85,
      description: "My go-to library for building interactive, production-grade UIs.",
    },
    {
      id: "javascript",
      skill: "JavaScript",
    ...
    },
    {
      ...
      icon: SiCplusplus,
      usage: 65,
      description: "I use C++ for DSA practice, performance-focused code, and learning HFT concepts.",
    },
    {
      id: "html",
      skill: "HTML5",
    ...
    },
    {
      ...
      icon: SiCss3,
      usage: 72,
      description: "I design responsive layouts and micro-interactions using modern CSS.",
    },
    {
      id: "swiftui",
      skill: "SwiftUI",
      icon: GrSwift,
      usage: 55,
      description: "I’ve built multiple personal iOS and macOS apps using SwiftUI.",
    },
    {
      id: "vscode",
      skill: "VSCode",
      icon: VscVscode,
      usage: 98,
      description: "My primary editor for development and custom extension building.",
    },
    {
      id: "xcode",
      skill: "Xcode",
      icon: SiXcode,
      usage: 62,
      description: "I use Xcode to build and debug Swift-based iOS and macOS projects.",
    },
    {
      id: "go",
      skill: "Go",
      icon: SiGo,
      usage: 50,
      description: "I used Go for backend and WebSocket development in my Sudoku app.",
    },
    {
      id: "shell",
      skill: "Shell/Bash",
      icon: SiGnubash,
      usage: 70,
      description: "I use Shell scripts for automation and developer tooling tasks.",
    },
    {
      id: "tailwind",
      skill: "Tailwind",
    ...
    },
    {
      ...
      icon: SiWebgl,
      usage: 70,
      description: "I use WebGL for interactive visuals like the cursor animation on this site.",
    },
  ];
